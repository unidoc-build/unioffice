...
func SetAsStorage (newStorage storage ){_g =newStorage };type storage interface{Open (_be string )(File ,error );TempFile (_cd ,_d string )(File ,error );TempDir (_f string )(string ,error );RemoveAll (_fe string )error ;Add (_fee string )error ;};
...
func Add (path string )error {return _g .Add (path )};var _g storage ;
